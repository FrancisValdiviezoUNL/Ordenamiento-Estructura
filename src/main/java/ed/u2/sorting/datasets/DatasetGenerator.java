...
public class DatasetGenerator {
    ...
    public static void generarCitas100(String outputPath) throws IOException {
        ...
        System.out.println("citas_100.csv generado en " + outputPath);
    }

    public static void generarCitas100CasiOrdenadas(String inputPath, String outputPath) throws IOException {
        ...
        System.out.println("citas_100_casi_ordenadas.csv generado en " + outputPath);
    }
    ...
    public static void generarPacientes500(String outputPath) throws IOException {
        ...
        System.out.println("pacientes_500.csv generado en " + outputPath);
    }

    public static void generarInventario500Inverso(String outputPath) throws IOException {
        try (FileWriter fw = new FileWriter(outputPath)) {
        ...
        System.out.println("inventario_500_inverso.csv generado en " + outputPath);
    }

    public static void main(String[] args) throws Exception {
        generarCitas100("citas.csv");
        generarCitas100CasiOrdenadas("citas.csv", "citas_casiOrdenadas.csv");
        generarPacientes500("pacientes.csv");
        generarInventario500Inverso("inventario_inverso.csv");
    }
}
